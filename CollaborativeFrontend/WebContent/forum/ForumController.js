...
app.controller('ForumController', [
		...
		function($scope, ForumService, $location, $rootScope) {
			...
			self.approveForum = function(forum, id) {
				console.log("-->BlogController : calling approveForum() method : getting forum with id : " + id);
				console.log("-->BlogController",self.forum);
				BlogService.approveBlog(forum, id).then(
						self.fetchAllForums,
						function(errResponse) {
			...
			self.likeForum = function(forum, id) {
				...
				console.log("-->ForumController", self.forum);
				ForumService.likeBlog(forum, id).then(
						self.fetchAllForums,
						function(errResponse) {
